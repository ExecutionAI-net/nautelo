...
| 11 | Listing workflow and immutable snapshots | 3, 4 | **implementing** | `2026-09-18-phase-11-listing-workflow.md` (merged, PR #33) | 15 tasks, ~7780 lines. Tasks 1-13 merged (PRs #36,#39,#40,#42,#44,#46,#47,#49,#50,#52,#55,#58,#60). Task 13 added staff-authored correction revisions (origin=STAFF_CORRECTION, publishes through the same approve_revision path as any other revision) and suspend/unsuspend services — domain services only, no HTTP endpoint yet by design (Phase 17's job, several forward-looking notes recorded in the ledger for that dispatch). Tasks 14-15 remain: public read API, phase acceptance tests. See ledger `.superpowers/sdd/2026-09-18-phase-11-listing-workflow/progress.md` for full detail. |
