...
| 11 | Listing workflow and immutable snapshots | 3, 4 | **implementing** | `2026-09-18-phase-11-listing-workflow.md` (merged, PR #33) | 15 tasks, ~7780 lines. Tasks 1-12 merged (PRs #36,#39,#40,#42,#44,#46,#47,#49,#50,#52,#55,#58). Task 12 added `POST /api/v1/staff/revisions/<id>/decision/`, the first network-reachable gate for the moderation services — adversarially security-reviewed, `IsStaffModerator` confirmed load-bearing (the decision services have zero actor-role checks of their own). Tasks 13-15 remain: staff-authored corrections + suspension (in flight), public read API, phase acceptance tests. See ledger `.superpowers/sdd/2026-09-18-phase-11-listing-workflow/progress.md` for full detail. |
