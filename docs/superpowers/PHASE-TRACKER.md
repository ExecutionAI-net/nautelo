...
| 11 | Listing workflow and immutable snapshots | 3, 4 | **implementing** | `2026-09-18-phase-11-listing-workflow.md` (merged, PR #33) | 15 tasks, ~7780 lines. Tasks 1-10 merged (PRs #36,#39,#40,#42,#44,#46,#47,#49,#50,#52). Task 10 added submit/withdraw services + post-commit domain signals; a real spec §27 test-quality gap (on_commit deferral was unproven by the brief's own tests) was found and independently reproduced fixed. Tasks 11-15 remain: snapshot builder + approve/request-changes/reject decisions, staff decision endpoint, staff-authored corrections + suspension, public read API, phase acceptance tests. See ledger `.superpowers/sdd/2026-09-18-phase-11-listing-workflow/progress.md` for full detail. |
