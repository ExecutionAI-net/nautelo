...
| 19 | Broker dashboard simplification and messages | 6, 12 | **ready** (implementation gated on Phase 6 Tasks 3-10) | `2026-09-18-phase-19-broker-dashboard-messages.md` (merged, PR #144) | 11 tasks (53 backend + 121 frontend new tests). Two review rounds; EN/IT/ES dictionary for the dashboard nav. Phase 6 dependency is now done; read its Contract summary. |
